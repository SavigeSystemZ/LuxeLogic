...
- App name: database
- App id: io.aiaast.database
- Desktop entry id: io.aiaast.database
- Android application id: io.aiaast.database
- Repo purpose:
- Product category:
- Primary users:
- Main workflows:
...
- Security or policy checks: bootstrap/scan-security.sh /home/whyte/.MyAppZ/LuxeLogic/database

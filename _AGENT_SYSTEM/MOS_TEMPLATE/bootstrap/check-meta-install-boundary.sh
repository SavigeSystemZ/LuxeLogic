...
usage() {
  cat <<'EOF'
Usage: check-meta-install-boundary.sh [target-repo]

Fail if maintainer-only or foreign product layers are present inside an installed MOS repo.
EOF
}

...
- [ ] HIGH: Refine `PRODUCT_BRIEF.md` for api-gateway so the product frame and first build shape are explicit
...
- [ ] HIGH: Establish the first validated baseline for api-gateway

## Immediate Queue

Use short, reviewable tasks with priority signals.

- [ ] MEDIUM: Finish onboarding and confirm the first working validation path for api-gateway

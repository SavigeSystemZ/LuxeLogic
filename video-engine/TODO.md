...
- [ ] HIGH: Refine `PRODUCT_BRIEF.md` for video-engine so the product frame and first build shape are explicit
...
- [ ] HIGH: Establish the first validated baseline for video-engine

## Immediate Queue

Use short, reviewable tasks with priority signals.

- [ ] MEDIUM: Finish onboarding and confirm the first working validation path for video-engine

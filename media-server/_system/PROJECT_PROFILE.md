...
- App id: io.aiaast.media.server
- Desktop entry id: io.aiaast.media.server
- Android application id: io.aiaast.media.server
- Repo purpose:
- Product category:
- Primary users:
- Main workflows:
...
- Security or policy checks: bootstrap/scan-security.sh /home/whyte/.MyAppZ/LuxeLogic/media-server

...
- Target label: starter-blueprint-alignment
- Intended audience: AIAST maintainers and downstream app-repo agents
- Release goal: prove the first blueprint-aligned vertical slice for core-service
...
- Release confidence: not ready until the blueprint-aligned validation minimum is proven
